...
import json 
from typing import List, Dict, Any # Added for compatibility if this was used in your full environment

# Call the CSS injection function (Restored original call for simplicity)
# If you have specific brand-hiding CSS, you would paste it here using st.markdown.
...
if generate_button:
    ...
    if not gemini_api_key:
        ...
        with st.spinner("Analyzing transcript and generating structured notes..."):
            try:
                # The old logic did not support passing format choice to the API, 
                # so we proceed with the standard call.
